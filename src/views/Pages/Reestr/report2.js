...
const Report2 = forwardRef(({ data = [], emitent }, ref) => {
  ...
  const exportToExcel = () => {
    ...
    const headers = ["Счет", "Ф.И.О", "Простых", "Номинал простых", "Привилегированных", "Номинал привилегированных", "% от кол-во", "Паспорт", "Адрес проживания", "Регион"];
    ...
    <div ref={printContentRef} className={classes.page}>
      <div className={classes.header}>
        <div className={classes.titleBlock}>
          <p className={classes.subtitle}>Реестр владельцев именных ценных бумаг</p>
          ...
          <Table className={classes.table}>
            <TableHead style={{ display: "table-header-group" }}>
              <TableRow>
                ...
                <TableCell className={classes.tableHeadCell}>Ф.И.О</TableCell>
                ...
                <TableCell className={classes.tableHeadCell}>Паспорт</TableCell>
                <TableCell className={classes.tableHeadCell}>Адрес проживания</TableCell>
                <TableCell className={classes.tableHeadCell}>Регион</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
